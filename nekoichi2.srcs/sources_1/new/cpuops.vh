// ========================== Memory ============================
`define CPU_RESET_VECTOR 32'h00000000
// ==============================================================
...
`define CPUSTORE				7
`define CPUSTORECOMPLETE		8
`define CPUSTOREF				9
`define CPURETIREINSTRUCTION	10
`define CPUSTALLF				11
`define CPUSTALLFF				12

`define CPUNONE_MASK				13'b000000000000

`define CPUFETCH_MASK				13'b0000000000001
`define CPUDECODE_MASK				13'b0000000000010
`define CPUSTALLM_MASK				13'b0000000000100
`define CPUEXEC_MASK				13'b0000000001000
`define CPULOADCOMPLETE_MASK		13'b0000000010000
`define CPULOADFCOMPLETE_MASK		13'b0000000100000
`define CPULOADWAIT_MASK			13'b0000001000000
`define CPUSTORE_MASK				13'b0000010000000
`define CPUSTORECOMPLETE_MASK		13'b0000100000000
`define CPUSTOREF_MASK				13'b0001000000000
`define CPURETIREINSTRUCTION_MASK	13'b0010000000000
`define CPUSTALLF_MASK				13'b0100000000000
`define CPUSTALLFF_MASK				13'b1000000000000
// ==============================================================
