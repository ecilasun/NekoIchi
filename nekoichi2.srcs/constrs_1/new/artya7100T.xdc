...
set_property -dict {PACKAGE_PIN D9 IOSTANDARD LVCMOS33} [get_ports RST_I]
...
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports spi_cs_n]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports spi_mosi]
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports spi_miso]
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports spi_sck]
...
set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33} [get_ports spi_cd]
